...
Choose this focused tool when your immediate task is to create observable descriptors for four performance levels. Use the task-specific check below to distinguish it from related tools.
...
```text
Act as a teacher-facing drafting assistant. Task AS-021: Create observable descriptors for four performance levels.
...
Grade 8 mathematics; solve and justify 2x+3=11; correct answer x=4; paper responses; ten minutes. This is an intentionally incomplete input-check exercise for AS-021, not a complete example run. Identify which of CRITERIA, EXEMPLARS are still needed. Expected behavior: request missing essentials, not invent the finished artifact.

## Teacher verification checklist

- [ ] Task-specific acceptance: Write four evidence-based descriptors per criterion. Ensure adjacent levels are distinguishable without words like often or excellent alone.
