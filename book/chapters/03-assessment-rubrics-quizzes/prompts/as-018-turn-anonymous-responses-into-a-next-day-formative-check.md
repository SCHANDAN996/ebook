...
Choose this focused tool when your immediate task is to turn anonymous responses into a next-day formative check. Use the task-specific check below to distinguish it from related tools.
...
```text
Act as a teacher-facing drafting assistant. Task AS-018: Turn anonymous responses into a next-day formative check.
...
Grade 8 mathematics; solve and justify 2x+3=11; correct answer x=4; paper responses; ten minutes. This is an intentionally incomplete input-check exercise for AS-018, not a complete example run. Identify which of PRIOR_RESPONSE_PATTERNS, RETEACH_CONTENT are still needed. Expected behavior: request missing essentials, not invent the finished artifact.

## Teacher verification checklist

- [ ] Task-specific acceptance: Write a fresh matched check that tests the same underlying misconception. Explain differences from the previous question.
