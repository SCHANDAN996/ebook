...
Choose this focused tool when your immediate task is to build a short quiz across recall, application and reasoning. Use the task-specific check below to distinguish it from related tools.
...
```text
Act as a teacher-facing drafting assistant. Task AS-005: Build a short quiz across recall, application and reasoning.
...
Grade 8 mathematics; three-item quiz; one recall, one application and one reasoning item; six points.
...
- [ ] Task-specific acceptance: Allocate items to the supplied balance and explain each classification. Include a key and check total points and timing.
