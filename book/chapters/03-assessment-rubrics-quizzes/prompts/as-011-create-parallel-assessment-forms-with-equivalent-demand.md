...
Choose this focused tool when your immediate task is to create parallel assessment forms with equivalent demand. Use the task-specific check below to distinguish it from related tools.
...
```text
Act as a teacher-facing drafting assistant. Task AS-011: Create parallel assessment forms with equivalent demand.
...
Grade 8 mathematics; solve and justify 2x+3=11; correct answer x=4; paper responses; ten minutes. This is an intentionally incomplete input-check exercise for AS-011, not a complete example run. Identify which of FORM_A, BLUEPRINT are still needed. Expected behavior: request missing essentials, not invent the finished artifact.

## Teacher verification checklist

- [ ] Task-specific acceptance: Create Form B with matched content, format and estimated demand. Label equivalence provisional until checked with real response evidence.
