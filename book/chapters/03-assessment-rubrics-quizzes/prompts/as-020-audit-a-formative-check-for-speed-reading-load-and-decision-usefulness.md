...
Choose this focused tool when your immediate task is to audit a formative check for speed, reading load and decision usefulness. Use the task-specific check below to distinguish it from related tools.
...
```text
Act as a teacher-facing drafting assistant. Task AS-020: Audit a formative check for speed, reading load and decision usefulness.
...
Grade 8 mathematics; solve and justify 2x+3=11; correct answer x=4; paper responses; ten minutes. This is an intentionally incomplete input-check exercise for AS-020, not a complete example run. Identify which of FORMATIVE_CHECK, AVAILABLE_ACTIONS are still needed. Expected behavior: request missing essentials, not invent the finished artifact.

## Teacher verification checklist

- [ ] Task-specific acceptance: Audit whether each response produces a usable decision within the lesson. Remove reading complexity unrelated to the target.
