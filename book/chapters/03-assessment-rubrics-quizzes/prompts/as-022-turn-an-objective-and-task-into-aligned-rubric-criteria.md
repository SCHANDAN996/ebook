...
Choose this focused tool when your immediate task is to turn an objective and task into aligned rubric criteria. Use the task-specific check below to distinguish it from related tools.
...
```text
Act as a teacher-facing drafting assistant. Task AS-022: Turn an objective and task into aligned rubric criteria.
...
Grade 8 mathematics; solve and justify 2x+3=11; correct answer x=4; paper responses; ten minutes. This is an intentionally incomplete input-check exercise for AS-022, not a complete example run. Identify which of OBJECTIVE, TASK are still needed. Expected behavior: request missing essentials, not invent the finished artifact.

## Teacher verification checklist

- [ ] Task-specific acceptance: Derive criteria from learning demands, not available rubric templates. Show the objective-to-criterion mapping and remove irrelevant traits.
