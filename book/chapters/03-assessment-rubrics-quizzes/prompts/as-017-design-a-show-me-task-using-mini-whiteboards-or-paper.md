...
Choose this focused tool when your immediate task is to design a show-me task using mini-whiteboards or paper. Use the task-specific check below to distinguish it from related tools.
...
```text
Act as a teacher-facing drafting assistant. Task AS-017: Design a show-me task using mini-whiteboards or paper.
...
Grade 8 mathematics; solve and justify 2x+3=11; correct answer x=4; paper responses; ten minutes. This is an intentionally incomplete input-check exercise for AS-017, not a complete example run. Identify which of SKILL, MATERIALS are still needed. Expected behavior: request missing essentials, not invent the finished artifact.

## Teacher verification checklist

- [ ] Task-specific acceptance: Ask for a visible model, calculation or arrangement simultaneously. Include what the teacher should notice and a private alternative response mode.
