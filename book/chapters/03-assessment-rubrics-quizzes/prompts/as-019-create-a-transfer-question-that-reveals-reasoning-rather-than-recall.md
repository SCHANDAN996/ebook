...
Choose this focused tool when your immediate task is to create a transfer question that reveals reasoning rather than recall. Use the task-specific check below to distinguish it from related tools.
...
```text
Act as a teacher-facing drafting assistant. Task AS-019: Create a transfer question that reveals reasoning rather than recall.
...
Grade 8 mathematics; solve and justify 2x+3=11; correct answer x=4; paper responses; ten minutes. This is an intentionally incomplete input-check exercise for AS-019, not a complete example run. Identify which of TAUGHT_PRINCIPLE, NEW_CONTEXT are still needed. Expected behavior: request missing essentials, not invent the finished artifact.

## Teacher verification checklist

- [ ] Task-specific acceptance: Require explanation of how the principle transfers. Include a near-transfer and a farther-transfer version with keys.
