...
Choose this focused tool when your immediate task is to calibrate a rubric using fictional work samples. Use the task-specific check below to distinguish it from related tools.
...
```text
Act as a teacher-facing drafting assistant. Task AS-026: Calibrate a rubric using fictional work samples.
...
Grade 8 mathematics; solve and justify 2x+3=11; correct answer x=4; paper responses; ten minutes. This is an intentionally incomplete input-check exercise for AS-026, not a complete example run. Identify which of RUBRIC, FICTIONAL_SAMPLES are still needed. Expected behavior: request missing essentials, not invent the finished artifact.

## Teacher verification checklist

- [ ] Task-specific acceptance: Score each sample criterion by criterion, cite evidence and show a borderline case. Ask reviewers to resolve disagreements before live scoring.
