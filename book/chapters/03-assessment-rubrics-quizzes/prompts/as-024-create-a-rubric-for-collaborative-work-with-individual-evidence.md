...
Choose this focused tool when your immediate task is to create a rubric for collaborative work with individual evidence. Use the task-specific check below to distinguish it from related tools.
...
```text
Act as a teacher-facing drafting assistant. Task AS-024: Create a rubric for collaborative work with individual evidence.
...
Grade 8 mathematics; solve and justify 2x+3=11; correct answer x=4; paper responses; ten minutes. This is an intentionally incomplete input-check exercise for AS-024, not a complete example run. Identify which of GROUP_TASK, INDIVIDUAL_TARGETS are still needed. Expected behavior: request missing essentials, not invent the finished artifact.

## Teacher verification checklist

- [ ] Task-specific acceptance: Separate collaboration-process evidence from individual subject mastery. Make each score traceable to the appropriate source.
