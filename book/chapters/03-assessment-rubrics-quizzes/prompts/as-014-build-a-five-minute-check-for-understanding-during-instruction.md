...
Choose this focused tool when your immediate task is to build a five-minute check for understanding during instruction. Use the task-specific check below to distinguish it from related tools.
...
```text
Act as a teacher-facing drafting assistant. Task AS-014: Build a five-minute check for understanding during instruction.
...
Grade 8 mathematics; solve and justify 2x+3=11; correct answer x=4; paper responses; ten minutes. This is an intentionally incomplete input-check exercise for AS-014, not a complete example run. Identify which of CURRENT_CONCEPT, FIVE_MINUTES are still needed. Expected behavior: request missing essentials, not invent the finished artifact.

## Teacher verification checklist

- [ ] Task-specific acceptance: Use a brief response plus reasoning probe and state immediate instructional choices. Avoid collecting more information than can be acted upon.
