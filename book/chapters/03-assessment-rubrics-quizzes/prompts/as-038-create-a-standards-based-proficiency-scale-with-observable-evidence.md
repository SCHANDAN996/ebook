...
Choose this focused tool when your immediate task is to create a standards-based proficiency scale with observable evidence. Use the task-specific check below to distinguish it from related tools.
...
```text
Act as a teacher-facing drafting assistant. Task AS-038: Create a standards-based proficiency scale with observable evidence.
...
Grade 8 mathematics; solve and justify 2x+3=11; correct answer x=4; paper responses; ten minutes. This is an intentionally incomplete input-check exercise for AS-038, not a complete example run. Identify which of STANDARD, LOCAL_PROFICIENCY_POLICY are still needed. Expected behavior: request missing essentials, not invent the finished artifact.

## Teacher verification checklist

- [ ] Task-specific acceptance: Draft observable levels consistent with the supplied policy. Do not invent official grading thresholds or claim a validated scale.
