...
Choose this focused tool when your immediate task is to write a missing-work message using dates and verified counts. Use the task-specific check below to distinguish it from related tools.
...
```text
Act as a teacher-facing drafting assistant. Task PC-010: Write a missing-work message using dates and verified counts.
...
Grade 6 class communication; fictional fact: the class completed a paper-based map activity; 80-word limit; no learner identities or school dates supplied. This is an intentionally incomplete input-check exercise for PC-010, not a complete example run. Identify which of VERIFIED_COUNTS, ASSIGNMENT_DATES, RECOVERY_OPTION are still needed. Expected behavior: request missing essentials, not invent the finished artifact.

## Teacher verification checklist

- [ ] Task-specific acceptance: Separate missing, late and ungraded work. Verify totals and avoid treating absence of submission as proof of refusal.
