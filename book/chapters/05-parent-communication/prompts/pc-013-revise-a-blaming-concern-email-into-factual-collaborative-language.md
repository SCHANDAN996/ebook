...
Choose this focused tool when your immediate task is to revise a blaming concern email into factual collaborative language. Use the task-specific check below to distinguish it from related tools.
...
```text
Act as a teacher-facing drafting assistant. Task PC-013: Revise a blaming concern email into factual collaborative language.
...
Grade 6 class communication; fictional fact: the class completed a paper-based map activity; 80-word limit; no learner identities or school dates supplied. This is an intentionally incomplete input-check exercise for PC-013, not a complete example run. Identify which of DRAFT_EMAIL, VERIFIED_FACTS are still needed. Expected behavior: request missing essentials, not invent the finished artifact.

## Teacher verification checklist

- [ ] Task-specific acceptance: Remove blame while retaining the material concern. Return original phrase, revision and reason; do not soften away important facts.
