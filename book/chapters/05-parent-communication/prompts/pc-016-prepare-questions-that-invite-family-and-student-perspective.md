...
Choose this focused tool when your immediate task is to prepare questions that invite family and student perspective. Use the task-specific check below to distinguish it from related tools.
...
```text
Act as a teacher-facing drafting assistant. Task PC-016: Prepare questions that invite family and student perspective.
...
Grade 6 class communication; fictional fact: the class completed a paper-based map activity; 80-word limit; no learner identities or school dates supplied. This is an intentionally incomplete input-check exercise for PC-016, not a complete example run. Identify which of CONFERENCE_TOPIC, KNOWN_EVIDENCE are still needed. Expected behavior: request missing essentials, not invent the finished artifact.

## Teacher verification checklist

- [ ] Task-specific acceptance: Write open, non-leading questions for family and student voice. Offer a right to decline personal disclosure.
