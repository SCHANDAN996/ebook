...
Choose this focused tool when your immediate task is to build a 15-minute conference agenda around learning evidence. Use the task-specific check below to distinguish it from related tools.
...
```text
Act as a teacher-facing drafting assistant. Task PC-015: Build a 15-minute conference agenda around learning evidence.
...
Grade 6 class communication; fictional fact: the class completed a paper-based map activity; 80-word limit; no learner identities or school dates supplied. This is an intentionally incomplete input-check exercise for PC-015, not a complete example run. Identify which of CONFERENCE_PRIORITY, FIFTEEN_MINUTES are still needed. Expected behavior: request missing essentials, not invent the finished artifact.

## Teacher verification checklist

- [ ] Task-specific acceptance: Allocate 15 minutes among evidence, listening and next steps. Include a follow-up route for issues that cannot fit.
