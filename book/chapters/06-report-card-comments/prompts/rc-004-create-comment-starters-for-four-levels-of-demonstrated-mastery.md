...
Choose this focused tool when your immediate task is to create comment starters for four levels of demonstrated mastery. Use the task-specific check below to distinguish it from related tools.

## Teacher inputs

- [GRADE_SUBJECT: exact age/grade and subject]
- [GOAL: the learning or communication purpose]
- [LOCAL_MASTERY_LEVELS: supply verified information; do not leave blank]
...
```text
Act as a teacher-facing drafting assistant. Task RC-004: Create comment starters for four levels of demonstrated mastery.
...
Write level-specific starters describing demonstrated evidence. Leave learner-specific evidence blank and preserve local terminology.
...
Fictional local categories secure, developing, beginning, insufficient evidence; target: support a claim with relevant details.

## Sample output

**Editorial illustration - selected excerpt, not a logged AI run or classroom result.**

Secure: [LEARNER] supports [CLAIM] with [VERIFIED_RELEVANT_DETAILS] and explains the links. Developing: [EVIDENCE] shows relevant details with an incomplete connection. Beginning: [EVIDENCE] shows recognition of a claim; selecting relevant support is the next step. Insufficient evidence: Current records do not yet support a judgment on [TARGET]. Fill only the matching frame; do not imply these categories are universal grading policy.

## Teacher verification checklist

- [ ] Task-specific acceptance: Write level-specific starters describing demonstrated evidence. Leave learner-specific evidence blank and preserve local terminology.
