...
{
  "id": "AD-015",
  "slug": "separate-observed-events-interpretation-and-next-action",
  "chapter": "teacher-admin-paperwork",
  "subtopic": "observation-reflections",
  "title": "Separate observed events, interpretation and next action",
  "grade_bands": [
    "3-5",
    "6-8",
    "9-12"
...
Choose this focused tool when your immediate task is to separate observed events, interpretation and next action. Use the task-specific check below to distinguish it from related tools.
...
```text
Act as a teacher-facing drafting assistant. Task AD-015: Separate observed events, interpretation and next action.
...
Fictional staff planning; two proposed actions: check answer keys and confirm room layout; neither owner nor deadline agreed. This is an intentionally incomplete input-check exercise for AD-015, not a complete example run. Identify which of EVENT_NOTES are still needed. Expected behavior: request missing essentials, not invent the finished artifact.

## Teacher verification checklist

- [ ] Task-specific acceptance: Build three columns: observation, interpretation and next action. Retain multiple plausible interpretations where evidence is weak.
