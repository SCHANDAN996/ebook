...
{
  "id": "AD-014",
  "slug": "write-an-evidence-based-reflection-after-a-classroom-observation",
  "chapter": "teacher-admin-paperwork",
  "subtopic": "observation-reflections",
  "title": "Write an evidence-based reflection after a classroom observation",
  "grade_bands": [
    "3-5",
    "6-8",
    "9-12"
...
Choose this focused tool when your immediate task is to write an evidence-based reflection after a classroom observation. Use the task-specific check below to distinguish it from related tools.
...
```text
Act as a teacher-facing drafting assistant. Task AD-014: Write an evidence-based reflection after a classroom observation.
...
Fictional staff planning; two proposed actions: check answer keys and confirm room layout; neither owner nor deadline agreed. This is an intentionally incomplete input-check exercise for AD-014, not a complete example run. Identify which of OBSERVATION_NOTES, LESSON_GOAL are still needed. Expected behavior: request missing essentials, not invent the finished artifact.

## Teacher verification checklist

- [ ] Task-specific acceptance: Reflect on observed events, possible explanations and next steps separately. Do not invent student reactions or observer judgments.
