...
{
  "id": "AD-005",
  "slug": "draft-a-meeting-request-with-purpose-preparation-and-time-limit",
  "chapter": "teacher-admin-paperwork",
  "subtopic": "staff-emails",
  "title": "Draft a meeting request with purpose, preparation and time limit",
  "grade_bands": [
    "3-5",
    "6-8",
    "9-12"
...
Choose this focused tool when your immediate task is to draft a meeting request with purpose, preparation and time limit. Use the task-specific check below to distinguish it from related tools.
...
```text
Act as a teacher-facing drafting assistant. Task AD-005: Draft a meeting request with purpose, preparation and time limit.
...
Fictional staff planning; two proposed actions: check answer keys and confirm room layout; neither owner nor deadline agreed. This is an intentionally incomplete input-check exercise for AD-005, not a complete example run. Identify which of PURPOSE, AVAILABLE_SLOTS, PREPARATION are still needed. Expected behavior: request missing essentials, not invent the finished artifact.

## Teacher verification checklist

- [ ] Task-specific acceptance: Offer a meeting request with decision goal and time limit. Use only confirmed scheduling options and timezone.
