...
{
  "id": "AD-010",
  "slug": "audit-meeting-minutes-for-invented-consensus-owners-or-deadlines",
  "chapter": "teacher-admin-paperwork",
  "subtopic": "agendas-and-minutes",
  "title": "Audit meeting minutes for invented consensus, owners or deadlines",
  "grade_bands": [
    "3-5",
    "6-8",
    "9-12"
...
Choose this focused tool when your immediate task is to audit meeting minutes for invented consensus, owners or deadlines. Use the task-specific check below to distinguish it from related tools.
...
```text
Act as a teacher-facing drafting assistant. Task AD-010: Audit meeting minutes for invented consensus, owners or deadlines.
...
Fictional staff planning; two proposed actions: check answer keys and confirm room layout; neither owner nor deadline agreed. This is an intentionally incomplete input-check exercise for AD-010, not a complete example run. Identify which of MINUTES, ORIGINAL_NOTES are still needed. Expected behavior: request missing essentials, not invent the finished artifact.

## Teacher verification checklist

- [ ] Task-specific acceptance: Trace each decision and deadline to the notes. Flag invented consensus and preserve dissent or unresolved questions.
