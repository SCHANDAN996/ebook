...
{
  "id": "WF-001",
  "slug": "standard-to-complete-unit",
  "chapter": "multi-step-workflows",
  "subtopic": "standard-to-complete-unit",
  "title": "Standard to complete unit",
...
# Standard to complete unit

## Outcome

Turn one supplied standard into an aligned unit, assessment and daily sequence.
...
1. Paste the standard verbatim and list constraints.
2. Unpack knowledge, skills and mastery criteria; teacher reviews.
3. Draft the final assessment and rubric; teacher corrects content and accessibility.
4. Build the lesson sequence backward from the approved assessment.
5. Run an alignment audit and produce the final unit pack.
