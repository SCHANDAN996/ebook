...
Choose this focused tool when your immediate task is to plan mixed-readiness groups with meaningful roles and accountability. Use the task-specific check below to distinguish it from related tools.
...
```text
Act as a teacher-facing drafting assistant. Task DF-034: Plan mixed-readiness groups with meaningful roles and accountability.
...
Grade 5 mathematics; compare 3/4 and 5/6 using equal wholes; paper strips available; 20 minutes; observed barrier: organizing a written explanation. This is an intentionally incomplete input-check exercise for DF-034, not a complete example run. Identify which of MIXED_GROUP_TASK, ROLE_OPTIONS are still needed. Expected behavior: request missing essentials, not invent the finished artifact.

## Teacher verification checklist

- [ ] Task-specific acceptance: Give every learner a reasoning role and independent evidence. Do not make one learner the permanent tutor or scribe.
