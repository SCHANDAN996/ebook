...
Choose this focused tool when your immediate task is to build temporary groups from anonymous learning evidence. Use the task-specific check below to distinguish it from related tools.
...
```text
Act as a teacher-facing drafting assistant. Task DF-032: Build temporary groups from anonymous learning evidence.
...
Grade 5 mathematics; compare 3/4 and 5/6 using equal wholes; paper strips available; 20 minutes; observed barrier: organizing a written explanation. This is an intentionally incomplete input-check exercise for DF-032, not a complete example run. Identify which of ANONYMOUS_PATTERNS, CAPACITY are still needed. Expected behavior: request missing essentials, not invent the finished artifact.

## Teacher verification checklist

- [ ] Task-specific acceptance: Group by current task needs with private neutral labels. Include an unassigned category when evidence is insufficient.
