...
Choose this focused tool when your immediate task is to design an open-ended investigation with clear evidence expectations. Use the task-specific check below to distinguish it from related tools.
...
```text
Act as a teacher-facing drafting assistant. Task DF-030: Design an open-ended investigation with clear evidence expectations.
...
Grade 5 mathematics; compare 3/4 and 5/6 using equal wholes; paper strips available; 20 minutes; observed barrier: organizing a written explanation. This is an intentionally incomplete input-check exercise for DF-030, not a complete example run. Identify which of INVESTIGABLE_QUESTION, EVIDENCE_LIMITS are still needed. Expected behavior: request missing essentials, not invent the finished artifact.

## Teacher verification checklist

- [ ] Task-specific acceptance: Define an open investigation with bounded resources, evidence expectations and several defensible outcomes. Do not invent observations.
