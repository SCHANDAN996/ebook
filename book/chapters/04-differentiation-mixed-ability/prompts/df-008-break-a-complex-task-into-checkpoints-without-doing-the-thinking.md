...
Choose this focused tool when your immediate task is to break a complex task into checkpoints without doing the thinking. Use the task-specific check below to distinguish it from related tools.
...
```text
Act as a teacher-facing drafting assistant. Task DF-008: Break a complex task into checkpoints without doing the thinking.
...
Grade 5 mathematics; compare 3/4 and 5/6 using equal wholes; paper strips available; 20 minutes; observed barrier: organizing a written explanation. This is an intentionally incomplete input-check exercise for DF-008, not a complete example run. Identify which of COMPLEX_TASK, CHECKPOINT_COUNT are still needed. Expected behavior: request missing essentials, not invent the finished artifact.

## Teacher verification checklist

- [ ] Task-specific acceptance: Chunk procedural demands while retaining the difficult thinking. Include a self-monitoring check at each boundary.
