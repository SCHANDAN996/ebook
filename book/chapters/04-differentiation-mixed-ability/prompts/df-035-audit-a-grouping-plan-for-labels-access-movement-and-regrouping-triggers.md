...
Choose this focused tool when your immediate task is to audit a grouping plan for labels, access, movement and regrouping triggers. Use the task-specific check below to distinguish it from related tools.
...
```text
Act as a teacher-facing drafting assistant. Task DF-035: Audit a grouping plan for labels, access, movement and regrouping triggers.
...
Grade 5 mathematics; compare 3/4 and 5/6 using equal wholes; paper strips available; 20 minutes; observed barrier: organizing a written explanation. This is an intentionally incomplete input-check exercise for DF-035, not a complete example run. Identify which of GROUP_PLAN, ACCESS_CONSTRAINTS are still needed. Expected behavior: request missing essentials, not invent the finished artifact.

## Teacher verification checklist

- [ ] Task-specific acceptance: Check isolation, labelling, movement and regrouping triggers. Keep accommodation details in approved local records, not public prompts.
