...
Choose this focused tool when your immediate task is to design tiered questions that move from access to transfer. Use the task-specific check below to distinguish it from related tools.
...
```text
Act as a teacher-facing drafting assistant. Task DF-015: Design tiered questions that move from access to transfer.
...
Grade 5 mathematics; compare 3/4 and 5/6 using equal wholes; paper strips available; 20 minutes; observed barrier: organizing a written explanation. This is an intentionally incomplete input-check exercise for DF-015, not a complete example run. Identify which of ACCESS_KNOWLEDGE, TRANSFER_TARGET are still needed. Expected behavior: request missing essentials, not invent the finished artifact.

## Teacher verification checklist

- [ ] Task-specific acceptance: Sequence questions from access to explanation to transfer. Keep every learner invited to higher-demand questions with needed support.
