...
Choose this focused tool when your immediate task is to chunk a demanding source without rewriting its claims. Use the task-specific check below to distinguish it from related tools.
...
```text
Act as a teacher-facing drafting assistant. Task DF-023: Chunk a demanding source without rewriting its claims.
...
Grade 5 mathematics; compare 3/4 and 5/6 using equal wholes; paper strips available; 20 minutes; observed barrier: organizing a written explanation. This is an intentionally incomplete input-check exercise for DF-023, not a complete example run. Identify which of AUTHORIZED_SOURCE, CHUNK_BOUNDARIES are still needed. Expected behavior: request missing essentials, not invent the finished artifact.

## Teacher verification checklist

- [ ] Task-specific acceptance: Chunk by meaning, keep source order and label omissions. Preserve qualifiers and uncertainty in every extracted section.
