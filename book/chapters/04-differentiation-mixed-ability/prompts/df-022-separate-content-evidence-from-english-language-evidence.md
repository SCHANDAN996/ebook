...
Choose this focused tool when your immediate task is to separate content evidence from English-language evidence. Use the task-specific check below to distinguish it from related tools.
...
```text
Act as a teacher-facing drafting assistant. Task DF-022: Separate content evidence from English-language evidence.
...
Grade 5 mathematics; compare 3/4 and 5/6 using equal wholes; paper strips available; 20 minutes; observed barrier: organizing a written explanation. This is an intentionally incomplete input-check exercise for DF-022, not a complete example run. Identify which of CONTENT_CRITERIA, LANGUAGE_CRITERIA are still needed. Expected behavior: request missing essentials, not invent the finished artifact.

## Teacher verification checklist

- [ ] Task-specific acceptance: Score content evidence and language evidence separately where policy permits. Do not equate limited English output with limited subject understanding.
