...
Choose this focused tool when your immediate task is to build a transfer challenge using a new context. Use the task-specific check below to distinguish it from related tools.
...
```text
Act as a teacher-facing drafting assistant. Task DF-029: Build a transfer challenge using a new context.
...
Grade 5 mathematics; compare 3/4 and 5/6 using equal wholes; paper strips available; 20 minutes; observed barrier: organizing a written explanation. This is an intentionally incomplete input-check exercise for DF-029, not a complete example run. Identify which of TAUGHT_CONTEXT, NEW_CONTEXT are still needed. Expected behavior: request missing essentials, not invent the finished artifact.

## Teacher verification checklist

- [ ] Task-specific acceptance: Design a transfer challenge with one meaningful changed condition. Provide a key explaining what transfers and what does not.
