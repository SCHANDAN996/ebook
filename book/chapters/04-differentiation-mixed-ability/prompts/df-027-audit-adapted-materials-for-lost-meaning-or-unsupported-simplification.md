...
Choose this focused tool when your immediate task is to audit adapted materials for lost meaning or unsupported simplification. Use the task-specific check below to distinguish it from related tools.
...
```text
Act as a teacher-facing drafting assistant. Task DF-027: Audit adapted materials for lost meaning or unsupported simplification.
...
Grade 5 mathematics; compare 3/4 and 5/6 using equal wholes; paper strips available; 20 minutes; observed barrier: organizing a written explanation. This is an intentionally incomplete input-check exercise for DF-027, not a complete example run. Identify which of ORIGINAL, ADAPTATION are still needed. Expected behavior: request missing essentials, not invent the finished artifact.

## Teacher verification checklist

- [ ] Task-specific acceptance: Compare claims, qualifiers and evidence sentence by sentence. Restore lost meaning and label any unresolved interpretation.
