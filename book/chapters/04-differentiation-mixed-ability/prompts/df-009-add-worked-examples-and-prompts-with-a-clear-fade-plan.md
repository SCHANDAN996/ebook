...
Choose this focused tool when your immediate task is to add worked examples and prompts with a clear fade plan. Use the task-specific check below to distinguish it from related tools.
...
```text
Act as a teacher-facing drafting assistant. Task DF-009: Add worked examples and prompts with a clear fade plan.
...
Grade 5 mathematics; compare 3/4 and 5/6 using equal wholes; paper strips available; 20 minutes; observed barrier: organizing a written explanation. This is an intentionally incomplete input-check exercise for DF-009, not a complete example run. Identify which of WORKED_EXAMPLE, TARGET_INDEPENDENCE are still needed. Expected behavior: request missing essentials, not invent the finished artifact.

## Teacher verification checklist

- [ ] Task-specific acceptance: Alternate model, incomplete example and independent attempt. Define a support-fade decision based on evidence, not a fixed learner category.
