...
Language demands may hide subject understanding. Use the task-specific check below to distinguish it from related tools.
...
```text
Act as a teacher-facing drafting assistant. Task DF-003: Make a task accessible to multilingual learners.
...
Grade 6 science; explain melting; barrier is unfamiliar subject vocabulary; no language proficiency assumed.
...
- [ ] Task-specific acceptance: Separate content from language demands. Provide vocabulary and rehearsal support without inferring proficiency from a home language.
