...
Choose this focused tool when your immediate task is to audit classroom supports for dependence and hidden lower expectations. Use the task-specific check below to distinguish it from related tools.
...
```text
Act as a teacher-facing drafting assistant. Task DF-011: Audit classroom supports for dependence and hidden lower expectations.
...
Grade 5 mathematics; compare 3/4 and 5/6 using equal wholes; paper strips available; 20 minutes; observed barrier: organizing a written explanation. This is an intentionally incomplete input-check exercise for DF-011, not a complete example run. Identify which of CURRENT_SUPPORT_PLAN, OBSERVATIONS are still needed. Expected behavior: request missing essentials, not invent the finished artifact.

## Teacher verification checklist

- [ ] Task-specific acceptance: Identify where adults or tools do the assessed thinking. Recommend one reduced-support trial while preserving required accommodations.
