...
Choose this focused tool when your immediate task is to add glossary, guiding questions and audio-access suggestions. Use the task-specific check below to distinguish it from related tools.
...
```text
Act as a teacher-facing drafting assistant. Task DF-025: Add glossary, guiding questions and audio-access suggestions.
...
Grade 5 mathematics; compare 3/4 and 5/6 using equal wholes; paper strips available; 20 minutes; observed barrier: organizing a written explanation. This is an intentionally incomplete input-check exercise for DF-025, not a complete example run. Identify which of SOURCE, GLOSSARY_NEEDS, AUDIO_OPTIONS are still needed. Expected behavior: request missing essentials, not invent the finished artifact.

## Teacher verification checklist

- [ ] Task-specific acceptance: Add an essential glossary and guiding questions. Describe approved audio access without uploading protected texts or learner recordings.
