...
Choose this focused tool when your immediate task is to create a plain-language companion beside the original text. Use the task-specific check below to distinguish it from related tools.
...
```text
Act as a teacher-facing drafting assistant. Task DF-024: Create a plain-language companion beside the original text.
...
Grade 5 mathematics; compare 3/4 and 5/6 using equal wholes; paper strips available; 20 minutes; observed barrier: organizing a written explanation. This is an intentionally incomplete input-check exercise for DF-024, not a complete example run. Identify which of ORIGINAL_TEXT, TARGET_READING_ACCESS are still needed. Expected behavior: request missing essentials, not invent the finished artifact.

## Teacher verification checklist

- [ ] Task-specific acceptance: Place a plain-language companion beside the source. Flag simplifications that lose technical meaning and avoid claiming identical reading difficulty.
