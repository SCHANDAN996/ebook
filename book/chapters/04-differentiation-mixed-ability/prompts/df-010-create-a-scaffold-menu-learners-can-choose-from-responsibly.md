...
Choose this focused tool when your immediate task is to create a scaffold menu learners can choose from responsibly. Use the task-specific check below to distinguish it from related tools.
...
```text
Act as a teacher-facing drafting assistant. Task DF-010: Create a scaffold menu learners can choose from responsibly.
...
Grade 5 mathematics; compare 3/4 and 5/6 using equal wholes; paper strips available; 20 minutes; observed barrier: organizing a written explanation. This is an intentionally incomplete input-check exercise for DF-010, not a complete example run. Identify which of AVAILABLE_SCAFFOLDS, STUDENT_CHOICE_LIMITS are still needed. Expected behavior: request missing essentials, not invent the finished artifact.

## Teacher verification checklist

- [ ] Task-specific acceptance: Create a student-readable support menu with purpose and exit condition. Keep supports available without public labels or penalties.
