...
Choose this focused tool when your immediate task is to reduce unnecessary reading load in a non-reading assessment. Use the task-specific check below to distinguish it from related tools.
...
```text
Act as a teacher-facing drafting assistant. Task DF-026: Reduce unnecessary reading load in a non-reading assessment.
...
Grade 5 mathematics; compare 3/4 and 5/6 using equal wholes; paper strips available; 20 minutes; observed barrier: organizing a written explanation. This is an intentionally incomplete input-check exercise for DF-026, not a complete example run. Identify which of ASSESSMENT, TARGET_CONSTRUCT are still needed. Expected behavior: request missing essentials, not invent the finished artifact.

## Teacher verification checklist

- [ ] Task-specific acceptance: Reduce incidental reading only when reading is not the assessed skill. Document changes and preserve required technical vocabulary.
