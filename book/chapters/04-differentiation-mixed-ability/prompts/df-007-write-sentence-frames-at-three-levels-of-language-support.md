...
Choose this focused tool when your immediate task is to write sentence frames at three levels of language support. Use the task-specific check below to distinguish it from related tools.
...
```text
Act as a teacher-facing drafting assistant. Task DF-007: Write sentence frames at three levels of language support.
...
Grade 6 science; explain a temperature observation; three language-support levels; content evidence supplied by teacher.
...
- [ ] Task-specific acceptance: Write light, medium and substantial sentence support for the same reasoning move. Leave the evidence and conclusion for the learner.
