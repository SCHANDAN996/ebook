...
Choose this focused tool when your immediate task is to identify the language demands hidden inside a subject task. Use the task-specific check below to distinguish it from related tools.
...
```text
Act as a teacher-facing drafting assistant. Task DF-018: Identify the language demands hidden inside a subject task.
...
Grade 5 mathematics; compare 3/4 and 5/6 using equal wholes; paper strips available; 20 minutes; observed barrier: organizing a written explanation. This is an intentionally incomplete input-check exercise for DF-018, not a complete example run. Identify which of SUBJECT_TASK, RESPONSE_FORMAT are still needed. Expected behavior: request missing essentials, not invent the finished artifact.

## Teacher verification checklist

- [ ] Task-specific acceptance: Identify vocabulary, syntax and discourse demands separately from subject knowledge. Select only supports relevant to the actual task.
