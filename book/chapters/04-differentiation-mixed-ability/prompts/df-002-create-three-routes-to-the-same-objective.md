...
A mixed-readiness class needs different entry points and one shared destination. Use the task-specific check below to distinguish it from related tools.
...
Grade 5 fractions; compare 3/4 and 5/6 using distance from one; strips, number lines or symbols available.
...
- [ ] Task-specific acceptance: Create three neutral-named routes with one common mastery check. Compare demand explicitly; do not assign routes by fixed ability labels.
