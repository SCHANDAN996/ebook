...
Choose this focused tool when your immediate task is to create structured partner rehearsal before independent writing. Use the task-specific check below to distinguish it from related tools.
...
```text
Act as a teacher-facing drafting assistant. Task DF-020: Create structured partner rehearsal before independent writing.
...
Grade 5 mathematics; compare 3/4 and 5/6 using equal wholes; paper strips available; 20 minutes; observed barrier: organizing a written explanation. This is an intentionally incomplete input-check exercise for DF-020, not a complete example run. Identify which of WRITING_GOAL, PARTNER_OPTIONS are still needed. Expected behavior: request missing essentials, not invent the finished artifact.

## Teacher verification checklist

- [ ] Task-specific acceptance: Plan think, rehearse, listen and revise steps before writing. Offer private recorded or written rehearsal where speaking is inaccessible.
