...
Choose this focused tool when your immediate task is to create a whole-class debrief that reconnects three task versions. Use the task-specific check below to distinguish it from related tools.
...
```text
Act as a teacher-facing drafting assistant. Task DF-017: Create a whole-class debrief that reconnects three task versions.
...
Grade 5 mathematics; compare 3/4 and 5/6 using equal wholes; paper strips available; 20 minutes; observed barrier: organizing a written explanation. This is an intentionally incomplete input-check exercise for DF-017, not a complete example run. Identify which of THREE_TASK_VERSIONS, SHARED_CONCEPT are still needed. Expected behavior: request missing essentials, not invent the finished artifact.

## Teacher verification checklist

- [ ] Task-specific acceptance: Write a debrief that compares representations and reconnects every route. Include an individual synthesis question.
