...
Choose this focused tool when your immediate task is to create a rotation plan for three changing instructional needs. Use the task-specific check below to distinguish it from related tools.
...
```text
Act as a teacher-facing drafting assistant. Task DF-033: Create a rotation plan for three changing instructional needs.
...
Grade 5 mathematics; compare 3/4 and 5/6 using equal wholes; paper strips available; 20 minutes; observed barrier: organizing a written explanation. This is an intentionally incomplete input-check exercise for DF-033, not a complete example run. Identify which of THREE_NEEDS, ROTATION_MINUTES are still needed. Expected behavior: request missing essentials, not invent the finished artifact.

## Teacher verification checklist

- [ ] Task-specific acceptance: Create a feasible teacher-attention schedule and independent work for other groups. State transition and regrouping rules.
