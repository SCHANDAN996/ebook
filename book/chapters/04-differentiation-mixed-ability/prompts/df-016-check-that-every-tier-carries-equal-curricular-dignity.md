...
Choose this focused tool when your immediate task is to check that every tier carries equal curricular dignity. Use the task-specific check below to distinguish it from related tools.
...
```text
Act as a teacher-facing drafting assistant. Task DF-016: Check that every tier carries equal curricular dignity.
...
Grade 5 mathematics; compare 3/4 and 5/6 using equal wholes; paper strips available; 20 minutes; observed barrier: organizing a written explanation. This is an intentionally incomplete input-check exercise for DF-016, not a complete example run. Identify which of TIERED_TASK_SET, CRITERIA are still needed. Expected behavior: request missing essentials, not invent the finished artifact.

## Teacher verification checklist

- [ ] Task-specific acceptance: Compare challenge, dignity, choice and credit across routes. Flag a route that prevents learners from demonstrating the stated goal.
