...
Choose this focused tool when your immediate task is to audit an extension for novelty, rigor and connection to the objective. Use the task-specific check below to distinguish it from related tools.
...
```text
Act as a teacher-facing drafting assistant. Task DF-031: Audit an extension for novelty, rigor and connection to the objective.
...
Grade 5 mathematics; compare 3/4 and 5/6 using equal wholes; paper strips available; 20 minutes; observed barrier: organizing a written explanation. This is an intentionally incomplete input-check exercise for DF-031, not a complete example run. Identify which of EXTENSION_TASK, CORE_OBJECTIVE are still needed. Expected behavior: request missing essentials, not invent the finished artifact.

## Teacher verification checklist

- [ ] Task-specific acceptance: Audit whether the challenge deepens the same learning. Replace novelty that is unrelated or dependent on expensive home resources.
