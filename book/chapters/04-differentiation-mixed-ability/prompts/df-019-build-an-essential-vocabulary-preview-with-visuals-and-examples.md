...
Choose this focused tool when your immediate task is to build an essential vocabulary preview with visuals and examples. Use the task-specific check below to distinguish it from related tools.
...
```text
Act as a teacher-facing drafting assistant. Task DF-019: Build an essential vocabulary preview with visuals and examples.
...
Grade 5 mathematics; compare 3/4 and 5/6 using equal wholes; paper strips available; 20 minutes; observed barrier: organizing a written explanation. This is an intentionally incomplete input-check exercise for DF-019, not a complete example run. Identify which of ESSENTIAL_TERMS, SOURCE_CONTEXT are still needed. Expected behavior: request missing essentials, not invent the finished artifact.

## Teacher verification checklist

- [ ] Task-specific acceptance: Create plain definitions, text-described visuals, examples and non-examples. Require human review of translations and avoid invented etymology.
